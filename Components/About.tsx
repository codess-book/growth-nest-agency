...
const values = [
  {
    ...
    desc: "No one-size-fits-all playbooks — every strategy is built around your specific business goals and audience.",
    accent: "#00e5a0",
  },
  {
    icon: BarChart3,
    title: "Data-Driven Decision Making",
    desc: "Every recommendation is backed by data, not guesswork.",
    accent: "#00b8ff",
  },
  {
    icon: PenTool,
    title: "Creative Content That Converts",
    desc: "Content designed to engage first, and convert visitors into customers.",
    accent: "#a78bfa",
  },
  {
    icon: TrendingUp,
    title: "SEO & Performance Focused",
    desc: "Every campaign is built with visibility and measurable performance in mind.",
    accent: "#00e5a0",
  },
  {
    icon: MessageCircle,
    title: "Transparent Communication",
    desc: "Clear reporting and honest updates — no jargon, no black boxes.",
    accent: "#00b8ff",
  },
  {
    icon: Wallet,
    title: "Affordable Solutions",
    desc: "Effective digital marketing that fits businesses of every size.",
    accent: "#a78bfa",
  },
  {
    icon: Cpu,
    title: "Latest AI & Marketing Tools",
    desc: "We use modern tools to work faster and smarter for your brand.",
    accent: "#00e5a0",
  },
  {
    icon: Target,
    title: "Long-Term Growth Focus",
    desc: "We build for sustainable growth, not one-off wins.",
    accent: "#00b8ff",
  },
];
...
const process = [
  {
    ...
    desc: "We begin by understanding your business, industry, target audience, competitors, and marketing goals. This helps us create a strategy tailored to your unique needs.",
    accent: "#00e5a0",
    icon: Search,
  },
  {
    ...
    desc: "Our team develops a customized digital marketing plan that includes content strategy, SEO, social media, and advertising recommendations designed to achieve your business objectives.",
    accent: "#00b8ff",
    icon: ClipboardList,
  },
  {
    ...
    desc: "We create engaging content, optimize your digital assets, and launch marketing campaigns across the most effective platforms to maximize visibility and lead generation.",
    accent: "#a78bfa",
    icon: Rocket,
  },
  {
    ...
    desc: "Using advanced analytics tools, we continuously monitor campaign performance, identify opportunities for improvement, and optimize strategies to achieve better results.",
    accent: "#fb923c",
    icon: LineChart,
  },
  {
    ...
    desc: "Transparency is important to us. We provide detailed performance reports, actionable insights, and strategic recommendations to ensure continuous business growth and long-term success.",
    accent: "#00e5a0",
    icon: FileBarChart,
  },
];
    ...
    >
      ...
      <div className="relative border-b border-white/[0.06]">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 100% 0%, rgba(0,184,255,0.07) 0%, transparent 60%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              GrowthNext is a digital marketing firm that helps all types of
              businesses to set a strong digital presence. For which we make
              proven marketing strategies for our clients. Our main goal is to
              generate leads for your business and achieve measurable business
              growth. At GrowthNext we offer services to boost your digital
              presence in the market, which can lead you to massive growth in
              terms of customers and their faith in you. At GrowthNext we
              believe each business has its own aura, has different values, and
              offers something special. To make you look different from others
              in the market, we have an expert team of people who will help and
              guide you with—
            </p>
              ...
              {highlights.map((h) => (
                <div key={h} className="flex items-start gap-2.5">
                  <CheckCircle2
                    ...
                    strokeWidth={2}
                  />
                  <span className="font-['DM_Sans',sans-serif] text-[13px] text-white/55 leading-snug">
                    {h}
                  </span>
                </div>
              ))}
            ...
            {values.map(({ icon: Icon, title, desc, accent }, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at 0% 0%, ${accent}0d, transparent 65%)`,
                  }}
                />
                <div
                ...
                <h3 className="font-['Syne',sans-serif] font-[700] text-[16px] text-white mb-3">
                  {title}
                </h3>
                <p className="font-['DM_Sans',sans-serif] text-[13px] text-white/40 leading-[1.75]">
                  {desc}
                </p>
              </div>
            ))}
      ...
      <div className="relative border-b border-white/[0.06]">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 100%, rgba(0,229,160,0.05) 0%, transparent 60%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
          ...
          >
            ...
            <p className="font-['DM_Sans',sans-serif] text-[15px] text-white/40 max-w-lg mx-auto leading-relaxed">
              From first call to full-scale growth — here's exactly how we work
              with you.
            </p>
          </div>
            ...
            {process.map(({ step, title, desc, accent, icon: Icon }, i) => (
              ...
              >
                ...
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-3xl"
                  style={{
                    background: `radial-gradient(circle at 0% 0%, ${accent}10, transparent 65%)`,
                  }}
                />
          ...
          >
            <div>
              ...
              <p className="font-['DM_Sans',sans-serif] text-[13.5px] text-white/40">
                Book your free consultation today and start your growth journey
                with Growth Next.
              </p>
            </div>
            <a
