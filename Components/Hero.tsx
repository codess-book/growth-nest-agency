    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(0,229,160,0.07) 0%, transparent 65%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0,184,255,0.05) 0%, transparent 60%)",
          }}
        />
        <div
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(0,229,160,0.4) 50%, transparent)",
        }}
      />
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
        <div className="grid lg:grid-cols-[1fr_420px] gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="relative inline-block">
                <span
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(135deg, #00e5a0 0%, #00b8ff 60%, #a78bfa 100%)",
                  }}
                >
                  Smarter.
                </span>
            ...
            >
              GrowthNext, founded by Yukta Daswani, is a digital marketing
              agency dedicated to helping businesses grow in the digital world.
              From SEO and social media to PPC and email marketing, we create
              strategies that turn online presence into meaningful business
              growth.
            </p>
            ...
            >
              ...
              >
                <span className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center group-hover:border-white/35 transition-colors">
                  <ArrowRight
                    size={13}
                    className="rotate-[45deg] group-hover:rotate-0 transition-transform duration-300"
                  />
                </span>
                See Our Services
              </a>
            ...
            >
              {stats.map(({ value, label, icon: Icon }) => (
                <div
                  key={label}
                  className="flex flex-col gap-1 p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-white/[0.12] hover:bg-white/[0.05] transition-all duration-200"
                >
                  <Icon
                    size={14}
                    className="text-emerald-400 mb-1 opacity-80"
                  />
                  <div className="font-['Syne',sans-serif] font-[700] text-[22px] text-white leading-none tracking-tight">
                    {value}
                  </div>
                  <div className="text-[11.5px] text-white/35 font-['DM_Sans',sans-serif] leading-tight">
                    {label}
                  </div>
                </div>
              ))}
                ...
                (
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-1.5 mb-1.5">
                      ...
                      <span className="text-[9.5px] text-white/45 font-['DM_Sans',sans-serif] truncate">
                        {label}
                      </span>
                    </div>
                    <div className="relative font-['Syne',sans-serif] font-[700] text-[15px] text-white leading-none mb-1 truncate">
                      {value}
                    </div>
                    <div className="relative text-[9px] text-white/35 font-['DM_Sans',sans-serif] truncate">
                      {sub}
                    </div>
                  </div>
                ),
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-[280px] h-[280px]">
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(0,229,160,0.18) 0%, rgba(0,184,255,0.08) 50%, transparent 70%)",
                  }}
                />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg,rgba(0,229,160,0.15),rgba(0,184,255,0.1))",
              ...
              ({
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[11px] text-white/50 font-['DM_Sans',sans-serif]">
                      {label}
                    </span>
                  </div>
                  <div className="font-['Syne',sans-serif] font-[700] text-[22px] text-white leading-none mb-1">
                    {value}
                  </div>
                  <div className="text-[11px] text-white/35 font-['DM_Sans',sans-serif]">
                    {sub}
                  </div>
                </div>
              ),
      ...
      >
        <div className="flex gap-0 animate-[marquee_28s_linear_infinite] whitespace-nowrap w-max">
          {[...marqueeItems, ...marqueeItems].map((item, i) => (
            <span
              key={i}
              className="inline-flex items-center gap-3 px-6 text-[12.5px] font-medium text-white/25 tracking-widest uppercase font-['DM_Sans',sans-serif]"
            >
              {item}
